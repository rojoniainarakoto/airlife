              ...
              <div class="shadow p-2 rounded-lg bg-white">
                <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                  ...
                  <div class="absolute flex justify-center bottom-0 mb-3">
                   ...
                   <p className="text-black">Jean Chris</p>
                    </div>
                  </div>
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                  <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    ...
                    <span class="mt-2 xl:mt-0">8h</span>
                  </p>
                  <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    <svg
                      class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                    ...
                    <span class="mt-2 xl:mt-0">10000 Ar</span>
                  </p>
                </div>
                ...
                <div class="grid grid-cols-2 mt-8">
                  <div class="flex items-center">
                    ...
                    <button class="ml-2 text-gray-800 line-clamp-1"><a href="/reservee"></a>Reserver</button>
                  </div>
            ...
            >
              <div class="shadow p-2 rounded-lg bg-white">
                <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                  ...
                  <div class="absolute flex justify-center bottom-0 mb-3">
                    <div class="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                   <p className="text-black">Richard Modest</p>
                    </div>
                  </div>
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                  <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    ...
                    <span class="mt-2 xl:mt-0">5h</span>
                  </p>
                  <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    <svg
                      class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                    ...
                    <span class="mt-2 xl:mt-0">20 000 Ar</span>
                  </p>
                </div>
              ...
              <div class="shadow p-2 rounded-lg bg-white">
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                  ...
                  <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    ...
                    <span class="mt-2 xl:mt-0">10 000 Ar</span>
                  </p>
                </div>
            ...
            >
              <div class="shadow p-2 rounded-lg bg-white">
                <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                  ...
                  <div class="absolute flex justify-center bottom-0 mb-3">
                    <div class="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                   <p className="text-black">Bema Kely</p>
                    </div>
                  </div>
