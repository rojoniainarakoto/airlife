  ...
  return (
    <div className="w-full h-screen bg-no-repeat bg-cover bg-opacity-30 text-white" style={{backgroundImage: `url(${background})`}}>
        <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <h3 className='md:text-7xl sm:text-6xl text-4xl font-bold md:py-6'>Voyageons ensemble</h3>
            ...
            Changez votre façon de voyager avec AirLife et découvrez de nouvelles expériences !
            </p>
